...
//   // Events ke liye data (Dono same rakha hai aapki request ke hisaab se)
//   const eventData = [...campaignData];

//   // Tab ke hisaab se data select karna
...
//             <thead>
//               <tr className="text-[11px] md:text-[12px] uppercase text-gray-400 font-bold border-b border-gray-50 bg-gray-50/30">
//                 {/* Header dynamic hai (Campaign/Event) */}
