...
//   const [activeTab, setActiveTab] = useState(campaign?.status === 'Completed' ? 'Campaign Details' : 'Event Details');

//   if (!campaign) return <div className="p-10 text-center font-bold">Loading...</div>;

//   const isCompleted = campaign.status === 'Completed';

//   // --- Common Progress Card (48% as per your Event Image) ---
//   const ProgressCard = () => (
//     <div className="bg-white p-6 md:p-10 rounded-[30px] border border-gray-100 shadow-sm mb-10">
//       <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center mb-8">
//         <div><h2 className="text-2xl md:text-3xl font-black text-gray-800 tracking-tight">₹ 7,80,000</h2><p className="text-gray-400 text-[10px] font-bold uppercase mt-1">Raised</p></div>
//         <div><h2 className="text-2xl md:text-3xl font-black text-gray-800 tracking-tight">₹ 15,00,000</h2><p className="text-gray-400 text-[10px] font-bold uppercase mt-1">Goal</p></div>
//         <div><h2 className="text-2xl md:text-3xl font-black text-gray-800 tracking-tight">48%</h2><p className="text-gray-400 text-[10px] font-bold uppercase mt-1">Progress</p></div>
//         <div><h2 className="text-2xl md:text-3xl font-black text-gray-800 tracking-tight">20</h2><p className="text-gray-400 text-[10px] font-bold uppercase mt-1">Days Left</p></div>
//       </div>
...
//           <div className="absolute right-0 top-1/2 -translate-y-1/2 w-4 h-4 bg-[#24b037] border-2 border-white rounded-full shadow-md"></div>
//         </div>
//       </div>
//     </div>
//   );
...
//   // --- Common Stats Box ---
//   const StatsBox = () => (
//     <div className="border border-gray-200 rounded-[20px] p-6 md:p-8 max-w-2xl space-y-5 bg-white shadow-sm mb-10">
//       <div className="flex justify-between items-center text-sm md:text-base"><span className="text-gray-400 font-bold">Goal Amount</span><span className="font-bold text-gray-800">₹ 15,00,000</span></div>
//       <div className="flex justify-between items-center text-sm md:text-base"><span className="text-gray-400 font-bold">Total Donars</span><span className="font-bold text-gray-800">324</span></div>
//       <div className="flex justify-between items-center text-sm md:text-base"><span className="text-gray-400 font-bold">Duration</span><span className="font-bold text-gray-800 tracking-tighter">5 May 2026 - 16 May 2026</span></div>
//     </div>
//   );

//   return (
//     <div className="p-4 md:p-10 bg-white min-h-screen font-sans max-w-[1200px] mx-auto overflow-x-hidden">
//       {/* Back Button */}
//       <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-gray-500 font-black mb-10 hover:text-gray-800 group transition-all">
//         <ArrowLeft size={24} className="group-hover:-translate-x-1 transition-transform" /> <span className="text-lg">Back</span>
//       </button>

//       {/* Top Banner */}
//       <div className="flex flex-col lg:flex-row gap-10 mb-12">
//         <div className="w-full lg:w-[420px] shrink-0">
//           <img src="https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=600" className="w-full h-[280px] object-cover rounded-[30px] shadow-sm" alt="event" />
//         </div>
//         <div className="flex-1 space-y-4 py-2 text-left">
//           <span className={`font-bold text-xs uppercase tracking-widest ${isCompleted ? 'text-green-500' : 'text-[#24b037]'}`}>
//             {isCompleted ? 'Complete' : 'Active'}
//           </span>
//           <h1 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight">Book Distribution Event</h1>
//           <p className="text-gray-400 font-bold text-lg leading-none">By Shiksha Foundation</p>
...
//       {/* Tabs Logic as per Images */}
//       <div className="flex gap-8 md:gap-14 border-b border-gray-100 mb-10 text-gray-400 font-bold overflow-x-auto whitespace-nowrap scrollbar-hide">
//         {(isCompleted ? ['Campaign Details', 'Profile'] : ['Event Details', 'Donation Details', 'Profile']).map((tab) => (
//           <span 
//             key={tab}
//             onClick={() => setActiveTab(tab)}
//             className={`pb-3 cursor-pointer transition-all border-b-4 text-sm md:text-base ${activeTab === tab ? 'text-gray-800 border-[#24b037]' : 'border-transparent hover:text-gray-600'}`}
//           >
//             {tab}
//           </span>
//         ))}
...
//         {/* --- EXTRA CONTENT FOR COMPLETED EVENT --- */}
//         {isCompleted && (
...
//                 <div className="w-full md:w-[350px] h-[200px] rounded-[20px] overflow-hidden shrink-0">
//                    <img src="https://images.unsplash.com/photo-1509099836639-18ba1795216d?w=400" className="w-full h-full object-cover" alt="update" />
//                 </div>
...
//               <button className="bg-[#24b037] hover:bg-[#1e8f2d] text-white px-12 py-3.5 rounded-xl font-bold text-lg shadow-lg active:scale-95 transition-all">
//                 Give Feedback
//               </button>
//             </div>
//           </div>
...
//   // 🟢 State Management
//   const [activeTab, setActiveTab] = useState('Event Details'); // Campaign Details renamed to Event Details
...
//   // --- SUB-COMPONENT: FEEDBACK PAGE UI ---
//   const FeedbackUI = () => {
//     const questions = [
//       { id: 1, text: "" },
...
//         <button onClick={() => setIsFeedbackOpen(false)} className="flex items-center gap-2 text-gray-500 font-bold mb-8 hover:text-gray-800 transition-all">
...
//             <div className="bg-[#c2f0d1] p-3 rounded-full text-[#24b037]"><CheckCircle2 size={35} fill="#24b037" className="text-white" /></div>
...
//                       {[1, 2, 3, 4, 5].map((star) => (
//                         <Star key={star} size={32} className={`cursor-pointer transition-all ${ratings[q.id] >= star ? "fill-[#24b037] text-[#24b037]" : "text-gray-300"}`} onClick={() => setRatings({...ratings, [q.id]: star})} strokeWidth={1.5} />
//                       ))}
//                     </div>
//                     <div className="flex justify-between w-full max-w-[210px] text-[12px] font-bold text-gray-500 px-1 mt-1 uppercase tracking-tighter"><span>Poor</span><span>Excellent</span></div>
//                   </div>
//                 </div>
//               </div>
//             ))}
...
//             <button onClick={() => navigate('/donor/donations')} className="bg-[#24b037] hover:bg-[#1e8f2d] text-white font-bold py-3.5 px-20 rounded-2xl text-xl shadow-lg transition-all active:scale-95">Submit</button>
//           </div>
//         </div>
//       </div>
//     );
...
//   // --- TAB 1: EVENT DETAILS (SAME AS CAMPAIGN DETAILS) ---
...
//             <div><h2 className="text-3xl font-black text-gray-800">48%</h2><p className="text-gray-400 text-[10px] font-bold uppercase mt-1">Progress</p></div>
...
//           <p className="text-gray-500 text-[15px] leading-relaxed max-w-5xl">This campaign aims to build a new Learning Center...</p>
//           <button className="text-[#24b037] font-bold text-sm">Read More</button>
//         </div>
//         <div className="border border-gray-200 rounded-[20px] p-8 max-w-2xl space-y-5 bg-[#fafafa]/50">
//             <div className="flex justify-between items-center text-left"><span className="text-gray-400 font-bold">Goal Amount</span><span className="font-bold text-gray-800">₹ 15,00,000</span></div>
//             <div className="flex justify-between items-center text-left"><span className="text-gray-400 font-bold">Total Donars</span><span className="font-bold text-gray-800">324</span></div>
//             <div className="flex justify-between items-center text-left"><span className="text-gray-400 font-bold">Duration</span><span className="font-bold text-gray-800">5 may 2026 - 16 may 2026</span></div>
//         </div>
//       </div>
//     );
...
//       <div className="animate-fadeIn space-y-10">
//         <div>
//           <h3 className="text-lg font-bold text-gray-800 mb-4 ml-1 text-left">About Event Progress</h3>
//           <div className="bg-white p-10 rounded-[30px] border border-gray-100 shadow-sm text-center">
//               <h2 className="text-4xl font-black text-[#24b037] mb-1 leading-none">100%</h2>
//               <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest mb-8 text-center">Of Goal Achieved</p>
//               <div className="w-full bg-[#24b037] h-3 rounded-full mb-10" />
//               <div className="flex justify-center divide-x divide-gray-100 text-center">
//                   <div className="px-12">
//                     <h3 className="text-2xl font-black text-gray-800">₹ 10,00,000</h3>
//                     <p className="text-gray-400 text-[10px] font-bold uppercase mt-1">Raised</p>
//                   </div>
//                   <div className="px-12">
//                     <h3 className="text-2xl font-black text-gray-800">₹ 10,00,000</h3>
//                     <p className="text-gray-400 text-[10px] font-bold uppercase mt-1">Goal</p>
//                   </div>
//               </div>
//           </div>
//         </div>
...
//                 <p className="text-gray-600 text-[14px] leading-relaxed text-left font-medium">
//                     Shiksha Foundation, through its ‘Shiksha Na Ruke’ initiative has been helping children from difficult circumstances continue their education...
//                 </p>
//             </div>
//             ))}
//         </div>
//         <div className="flex justify-center pt-6"><button onClick={() => setIsFeedbackOpen(true)} className="bg-[#24b037] hover:bg-[#1e8f2d] text-white px-12 py-3 rounded-xl font-bold text-lg shadow-lg transition-all active:scale-95">Give Feedback</button></div>
//       </div>
//     );

//     return isCompleted ? <CompletedContent /> : <ActiveContent />;
//   };

//   // --- TAB 2: DONATION DETAILS UI ---
...
//            <div className="flex gap-4 items-center"><span className="w-48 text-gray-400 font-bold">Amount</span><span className="font-black text-lg text-gray-700">₹ 1000</span></div>
//            <div className="flex gap-4 items-center"><span className="w-48 text-gray-400 font-bold">Status</span><span className="font-black text-lg text-green-500">Successful</span></div>
//         </div>
//       </div>
//     </div>
//   );

//   // --- 🟢 TAB 3: NGO PROFILE UI (NEW - BILKUL PHOTO JAISA) ---
//   const ProfileUI = () => (
//     <div className="animate-fadeIn space-y-12 pb-10 max-w-4xl mx-auto">
//       <div className="text-left space-y-1">
//         <h3 className="text-2xl font-bold text-gray-900 leading-tight">NGO Profile</h3>
//         <p className="text-gray-400 text-xs font-medium">Manage your NGO Profile</p>
//       </div>

//       <div className="border-t border-gray-100 pt-10">
//         <h4 className="text-lg font-bold text-gray-800 mb-8 text-left uppercase tracking-tight">Organization Details</h4>
...
//             <div>
//               <p className="text-gray-400 text-[13px] font-bold mb-1">NGO name</p>
//               <h5 className="text-xl font-bold text-gray-900">Helping Hands NGO</h5>
//             </div>
//             <div>
//               <p className="text-gray-400 text-[13px] font-bold mb-1">Email</p>
//               <h5 className="text-xl font-bold text-gray-900">hello@helpinhands.org</h5>
//             </div>
//             <div>
//               <p className="text-gray-400 text-[13px] font-bold mb-1">Phone</p>
//               <h5 className="text-xl font-bold text-gray-900">+91 2343446576</h5>
//             </div>
//             <div>
//               <p className="text-gray-400 text-[13px] font-bold mb-1">Address</p>
//               <h5 className="text-xl font-bold text-gray-900 leading-relaxed">123-Green Park,Mumbai <br/> 401047</h5>
//             </div>
//           </div>
//         </div>
//       </div>
...
//         <h4 className="text-xl font-bold text-gray-800 text-left">About Us</h4>
//         <p className="text-gray-500 text-[15px] leading-[1.8] text-left font-medium">
//           The Helping Hands Foundation is a non-profit organization, which works with children who 
//           are diagnosed with cancer. We work on two projects — the Accommodation Project and the 
//           Survivor Project. The Accommodation Project provides free accommodation to the child 
//           and the family during treatment in Dharamshalas surrounding the hospital and the 
//           Survivor Project works towards regular testing and rehabilitation of children who beat 
//           cancer. The Helping Hands Foundation is a fund raising entity and works in conjunction with 
...
//   // --- LOGIC: RENDER FEEDBACK PAGE OR DETAIL PAGE ---
//   if (isFeedbackOpen) {
...
//           <span className={`font-black text-[12px] uppercase tracking-[0.2em] px-3 py-1 rounded-md ${isCompleted ? 'bg-green-50 text-green-500' : 'bg-[#e7f7ed] text-[#24b037]'}`}>
//             {isCompleted ? 'Complete' : 'Active'}
//           </span>
...
//           <p className="text-gray-500 text-[17px] font-medium leading-relaxed max-w-xl">We empower students with hands-on learning, expert guidance, and innovative training programs for real-world success.</p>
//         </div>
//       </div>

//       {/* 🟢 TABS (EVENT DETAILS, DONATION DETAILS, PROFILE) */}
...
//     const handleStarClick = (qId, starValue) => {
//       // Refresh rokne ke liye state update
...
//                         <button
//                           key={star}
//                           type="button" // 🟢 FIXED: type button refresh rokta hai
...
//           </div>
//           <div className="flex justify-center mt-12">
//             <button type="button" onClick={() => navigate('/donor/donations')} className="bg-[#24b037] hover:bg-[#1e8f2d] text-white font-bold py-3.5 px-20 rounded-2xl text-xl shadow-lg transition-all active:scale-95">Submit</button>
//           </div>
//         </div>
//       </div>
//     );
...
//         </p>
//         <button className="text-[#24b037] font-bold text-sm hover:underline">Read More</button>
//       </div>
...
//             </div>
//           ))}
//           <div className="flex justify-center"><button onClick={() => setIsFeedbackOpen(true)} className="bg-[#24b037] text-white px-12 py-3 rounded-xl font-bold text-lg shadow-lg active:scale-95">Give Feedback</button></div>
//         </div>
//       )}
//     </div>
//   );
