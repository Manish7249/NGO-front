...
const EventDonationInvoice = ({ data }) => {
  ...
  const invoiceData = {
    ...
    eventName: data.event || "Education for every child",
    ...
    >
      ...
      <div style={{ marginBottom: '40px', lineHeight: '1.8' }}>
        ...
        <p style={{ margin: 0, fontSize: '17px', fontWeight: '600' }}>
          Event Name : {invoiceData.eventName}
        </p>
        <p style={{ margin: 0, fontSize: '17px', fontWeight: '600' }}>
      ...
      >
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            <tr>
              <td style={cellStyle}>Event Donation</td>
...
export default EventDonationInvoice;