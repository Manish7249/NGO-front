    ...
    <div className="bg-white min-h-screen font-sans animate-fadeIn pb-10">
      ...
      <div className="max-w-[1100px] mx-auto p-4 md:p-8">
        ...
        <div className="mt-16 flex flex-col items-center gap-3">
          <button onClick={() => navigate('/donor/donate/education/view/campaign-detail/campaign-payment/success', { state: { amount: selectedAmount } })} className="w-full max-w-[800px] bg-[#24b037] hover:bg-[#1e8f2d] text-white py-4 rounded-2xl font-black text-xl shadow-xl shadow-green-100 transition-all active:scale-95 flex items-center justify-center gap-3">
